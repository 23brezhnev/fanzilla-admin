<template>
  <div>
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px">
      <h2 style="margin: 0; font-size: 24px; font-weight: 700">Ценовые шаблоны</h2>
      <n-button type="primary" @click="router.push('/pricing/templates/create')">
        + Создать шаблон
      </n-button>
    </div>
