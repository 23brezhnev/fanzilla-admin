<template>
  <div>
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px">
      <h2 style="margin: 0; font-size: 24px; font-weight: 700">Типы билетов</h2>
    ...
    <n-modal
      ...
      :title="editingItem ? 'Редактирование типа билета' : 'Создание типа билета'"
      preset="card"
      ...
      >
        ...
        <n-form-item label="Описание" path="description">
          <n-input
            ...
            type="textarea"
            placeholder="Описание типа билета"
            :rows="2"
          />
        </n-form-item>
  ...
  modalFormRef.value?.validate((errors) => {
    if (!errors) {
      if (editingItem.value) {
        message.success('Тип билета обновлён')
      } else {
        message.success('Тип билета создан')
      }
